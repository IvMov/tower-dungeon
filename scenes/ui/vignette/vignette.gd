...
func on_aiming_player(aiming: bool):
	var tween = create_tween().set_parallel(true)
	if aiming:
		tween.tween_property(color_rect, "material:shader_parameter/vignette_opacity", 0.1, 0.5)
		tween.tween_property(color_rect, "material:shader_parameter/vignette_intensity", 0.1, 0.5)
	else:
		tween.tween_property(color_rect, "material:shader_parameter/vignette_opacity", 0.5, 0.5)
		tween.tween_property(color_rect, "material:shader_parameter/vignette_intensity", 0.4, 0.5)
