class_name SkeletonProjectile extends Node3D
...
func rotate_projectile(delta) -> void:
	mesh_instance_3d.rotate(Vector3.RIGHT, delta * 10)
	projectile_particles.rotate(Vector3.RIGHT, delta * 10)
